...
#ifndef NIGHTGUARD_COMPLICATIONEXTENSION_SWIFT_H
#define NIGHTGUARD_COMPLICATIONEXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="nightguard_ComplicationExtension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
SWIFT_CLASS("_TtC32nightguard_ComplicationExtension10BloodSugar")
@interface BloodSugar : NSCoder <NSSecureCoding>
...
SWIFT_CLASS("_TtC32nightguard_ComplicationExtension16DeviceStatusData")
@interface DeviceStatusData : NSObject <NSSecureCoding>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC32nightguard_ComplicationExtension22NightscoutCacheService")
@interface NightscoutCacheService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC32nightguard_ComplicationExtension14NightscoutData")
@interface NightscoutData : NSObject <NSSecureCoding>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) BOOL supportsSecureCoding;)
+ (BOOL)supportsSecureCoding SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC32nightguard_ComplicationExtension19TemporaryTargetData")
@interface TemporaryTargetData : NSObject <NSSecureCoding>
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) BOOL supportsSecureCoding;)
+ (BOOL)supportsSecureCoding SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC32nightguard_ComplicationExtension9Treatment")
@interface Treatment : NSObject <NSSecureCoding>
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) BOOL supportsSecureCoding;)
+ (BOOL)supportsSecureCoding SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * _Nonnull)aCoder;
...
SWIFT_CLASS("_TtC32nightguard_ComplicationExtension19WatchMessageService")
@interface WatchMessageService : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@class WCSession;
@interface WatchMessageService (SWIFT_EXTENSION(nightguard_ComplicationExtension)) <WCSessionDelegate>
