...
class ChartPainter {
    ...
    fileprivate func paintEverySecondHour(_ context : CGContext, attrs : [String : AnyObject]) {
    ...
    fileprivate func paintHourTimestamps(_ context : CGContext, attrs : [String : AnyObject]) {
