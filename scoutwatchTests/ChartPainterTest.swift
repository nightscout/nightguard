...
class ChartPainterTest: XCTestCase {
    ...
    func testXMinAdjustementIsWorking() {
        chartPainter.adjustMinMaxXYCoordinates([BloodSugar.init(value: 100, timestamp: 10000), BloodSugar.init(value: 200, timestamp: 20000)], yesterdaysValues: [])
    ...
    func testYMaxAdjustementIsWorking() {
        chartPainter.adjustMinMaxXYCoordinates([BloodSugar.init(value: 220, timestamp: 0)], yesterdaysValues: [])
        XCTAssertEqual(chartPainter.maximumYValue, 220)
    }
    
    func testYValue0IsDisplayedAtTheBottomOfTheCanvas() {
        chartPainter.adjustMinMaxXYCoordinates([BloodSugar.init(value: 0, timestamp: 0)], yesterdaysValues: [])
        XCTAssertEqual(Int(chartPainter.calcYValue(0)), chartPainter.canvasHeight)
    }
    
    func testYValue200IsDisplayedAtTheTopOfTheCanvas() {
        chartPainter.adjustMinMaxXYCoordinates([BloodSugar.init(value: 200, timestamp: 0), BloodSugar.init(value: 100, timestamp: 10000)], yesterdaysValues: [])
        XCTAssertEqual(Int(chartPainter.calcYValue(200)), 0)
    }
    
    func testYValue300IsDisplayedAtTheTopOfTheCanvas() {
        chartPainter.adjustMinMaxXYCoordinates([BloodSugar.init(value: 300, timestamp: 0), BloodSugar.init(value: 100, timestamp: 10000)], yesterdaysValues: [])
        XCTAssertEqual(Int(chartPainter.calcYValue(300)), 0)
    }
    
    func testYValue40IsDisplayedAtTheBottomOfTheCanvas() {
        chartPainter.adjustMinMaxXYCoordinates([BloodSugar.init(value: 40, timestamp: 0)], yesterdaysValues: [])
